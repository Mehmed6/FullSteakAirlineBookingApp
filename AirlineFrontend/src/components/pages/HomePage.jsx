...
const HomePage = () => {
    ...
    const handleSearch = e => {
        ...
        if (!searchData.departureIataCode || !searchData.arrivalIataCode || !searchData.departureDate) {
            showError("All fields are required for search.");
            return;
        }
        ...
        <div className="home-page">
            <div className="hero-section">
                <div className="hero-content">
                    <h1>Book Your Flight with Dogan Airlines</h1>
                        ...
                        <div className="search-fields">
                            <div className="form-group">
                                ...
                                <select
                                    ...
                                    onChange={(e) => setSearchData({
                                        ...searchData, departureIataCode: e.target.value})}
                                    required
                                >
                            ...
                            <div className="form-group">
                                ...
                                <select
                                    ...
                                    onChange={(e) => setSearchData({
                                        ...searchData, arrivalIataCode: e.target.value})}
                                    required
                                >
            ...
            <section className="features-section">
                <h2>Why Choose Dogan Airlines?</h2>
                ...
                <div className="testimonials-grid">
                    <div className="testimonial-card">
                        <div className="testimonial-text">
                            "The service was exceptional from booking to landing. Will definitely fly with Dogan again!"
                        </div>
