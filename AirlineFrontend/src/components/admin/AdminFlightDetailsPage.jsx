  ...
  const {id} = useParams();
    ...
    const fetchFlightDetails = async () => {
        try {
            ...
            setSelectedStatus(flightRes.data.flightStatus);
            setBookings(bookingsRes.data.filter(booking => Number(booking.flight?.id) === Number(id)));
    ...
    const handleStatusChange = async () => {
        try {
            const response = await ApiService.updateFlight({
                id: flight.id,
                            ...
                            {bookings.map(booking => (
                                <div key={booking.id} className="admin-booking-item">
                                    <div className="admin-booking-header">
                                        ...
                                        <div className={`admin-booking-status ${booking.bookingStatus.toLowerCase()}`}>
